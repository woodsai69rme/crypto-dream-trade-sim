-- Phase 1: Fix Core Account System

-- First, ensure we have proper account templates
...
('Day Trading Pro', 'Active day trading account', 'day_trading', 'high', 25000, 5000, 12500, 'scalping', '#f59e0b', 'Zap', ARRAY['daytrading', 'active'], true, NULL),
('Crypto Focus', 'Cryptocurrency trading specialist', 'crypto_focus', 'medium', 30000, 4000, 15000, 'manual', '#8b5cf6', 'Bitcoin', ARRAY['crypto', 'digital'], true, NULL)
