...
-- Fix the missing columns in paper_trades table that are causing the execute_paper_trade function to fail
...
-- Update the execute_paper_trade function to handle the new columns properly
...
BEGIN
  ...
  -- Insert the trade with all required columns
